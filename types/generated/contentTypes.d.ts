...
export interface ApiAllInclusiveFeatureAllInclusiveFeature
  extends Struct.CollectionTypeSchema {
  collectionName: 'all_inclusive_features';
  info: {
    displayName: 'all-inclusive-feature';
    pluralName: 'all-inclusive-features';
    singularName: 'all-inclusive-feature';
  };
  options: {
...
export interface ApiAllInclusivePlanAllInclusivePlan
  extends Struct.CollectionTypeSchema {
  collectionName: 'all_inclusive_plans';
  info: {
    displayName: 'all-inclusive-plan';
    pluralName: 'all-inclusive-plans';
    singularName: 'all-inclusive-plan';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiContactInfoContactInfo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email_icon: Schema.Attribute.JSON &
      ...
      >;
    has_email: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    has_phone_mx: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    has_phone_rest: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    has_phone_us: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    phone_mx_icon: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::strapi-plugin-iconhub.iconhub',
        {
          storeIconData: true;
    ...
    phone_rest_icon: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::strapi-plugin-iconhub.iconhub',
        {
          storeIconData: true;
    ...
    phone_us_icon: Schema.Attribute.JSON &
      Schema.Attribute.CustomField<
        'plugin::strapi-plugin-iconhub.iconhub',
        {
          storeIconData: true;
...
export interface ApiFooterFooter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliations: Schema.Attribute.DynamicZone<
      ['simple-components.media', 'simple-components.separator']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    extra_text: Schema.Attribute.Blocks &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    show_affiliations: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      ...
      Schema.Attribute.DefaultTo<true>;
    show_extra_text: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      ...
      Schema.Attribute.DefaultTo<false>;
    show_site_map: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiNavbarNavbar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    select_lang: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiPlanPivotPlanPivot extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'planPivot';
    pluralName: 'plans-pivot';
    singularName: 'plan-pivot';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiRoomAmenityRoomAmenity extends Struct.CollectionTypeSchema {
  collectionName: 'room_amenities';
  info: {
    displayName: 'room_amenity';
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    room_card: Schema.Attribute.Component<'rooms.room-card', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSiteSite extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    contact_fields: Schema.Attribute.Component<'shared.contact', false>;
